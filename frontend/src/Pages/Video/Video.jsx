...
const Video = () => {
    ...
    const fetchVedioById = async () => {
        await axios.get(`http://localhost:3500/api/getVideoById/${id}`).then((response) => {
    ...
    const getCommentByVideoId = async () => {
        await axios.get(`http://localhost:3500/commentApi/comment/${id}`).then((response) => {
    ...
    const handleComment = async()=>{
        ...
        await axios.post('http://localhost:3500/commentApi/comment',body, { withCredentials: true }).then((resp)=>{
            console.log(resp)
                    ...
                    <div className="youtube_video_ProfileBlock">
                        ...
                        <div className="youtube_video_likeBlock">
                            <div className="youtube_video_likeBlock_Like">
                                <ThumbUpOutlinedIcon />
                                <div className="youtube_video_likeBlock_NoOfLikes">{26}</div>
                            </div>
...
{/* my comments */}
                <div className="youtubeCommentSection">
                    ...
                    <div className="youtubeSelfComment">
                        <img className="video_youtubeSelfCommentProfile" src='https://upload.wikimedia.org/wikipedia/commons/b/bc/Unknown_person.jpg'/>
