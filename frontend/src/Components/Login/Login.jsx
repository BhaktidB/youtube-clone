...
const Login = ({ setLoginModal }) => {
    ...
    const handleLoginFun = async () => {
        setLoader(true)
        axios.post("http://localhost:3500/auth/login", loginField, { withCredentials: true }).then((resp => {
            setLoader(false)
        ...
        <div className='login'>
            <div className="login_card">
                ...
                <div className="loginCredentials">
                    ...
                    <div className="userNameLogin">
                        <input type="password" value={loginField.password} onChange={(e) => handleOnChangeInput(e, "password")} className="userNameLoginUserName" placeholder='Passord' />
                    </div>
                </div>
